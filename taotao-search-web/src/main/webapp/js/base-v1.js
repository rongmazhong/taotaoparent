 ...
 */
function login() {
    return location.href = "http://localhost:18084/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:18084/user/showRegister";
}
...
function search(a) {
    var b = "http://localhost:18085/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
